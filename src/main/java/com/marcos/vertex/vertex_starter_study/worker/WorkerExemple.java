package com.marcos.vertex.vertex_starter_study.worker;
...
public class WorkerExemple extends AbstractVerticle {

  private static final Logger LOG = LoggerFactory.getLogger(WorkerExemple.class);

  public static void main(String[] args) {
    var vertx = Vertx.vertx();
    vertx.deployVerticle(WorkerExemple.class.getName());
  }
